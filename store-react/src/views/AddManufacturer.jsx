...
class AddManufacturer extends React.Component {
  ...
  handleInputChange = (event) => {
    ...
    this.setState({ manufacturer: Object.assign(manufacturer, data) })
  }
  ...
  inputIsValid = () => {
    return this.state.manufacturer.name.length > 0
  }
                  ...
                  <Col className="offset-lg-0 offset-md-3" lg="5" md="6">
                    ...
                    <Card className="card-register">
                      <CardHeader>
                        ...
                        />
                        <CardTitle tag="h4">Add Manfct</CardTitle>
                      </CardHeader>
                      <CardBody>
                        <Form className="form">
                        <InputGroup>
                      ...
                      <CardFooter>
                        <Button className="btn-round" color="primary" size="lg" onClick={ this.addManufacturer }>
                          Add
                        </Button>
                      </CardFooter>
                    </Card>
